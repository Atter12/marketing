-- Igual que supabase/migrations/047_clientes_sync_creativos_tareas_trigger.sql
-- Trigger: cada alta/edición en clientes (Crédito) crea o actualiza Pendientes + Creativos.
