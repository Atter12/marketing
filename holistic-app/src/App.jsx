            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <TableScrollWrap className={"hm-table-wrap hm-table-sticky-actions hm-table-garantias" + (isCliente ? " hm-table-garantias--solo-cliente" : "")}><table><thead><tr>{!isCliente && <th style={{ ...TH, width: 32 }}><input type="checkbox" checked={allOnPageSelected} onChange={() => selectAllOnPage("garantias", idsOnPage)} title="Seleccionar página" style={{ cursor: "pointer", width: 16, height: 16 }} /></th>}{["Cliente", "Cód. verif.", "Cód. gasto", "Gasto ($)", "Tipo", "Descripción", "Valor", "Estado", "Colocación", "Usuario", "Registrado", "Imágenes", ""].map((h) => <th key={h || "actions"} style={TH} className={h === "" ? "hm-col-actions" : undefined}>{h}</th>)}</tr></thead>
