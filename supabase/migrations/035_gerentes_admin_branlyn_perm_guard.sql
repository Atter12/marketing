-- Branlyn como administrador; admins sin perm_estandar redundante; bloqueo de escalación de permisos.
-- Requiere public.is_gerente_admin() (migración 030).
...
-- Un administrador no debería seguir marcado como «estándar» en BD (evita etiquetas confusas en UI).
update public.gerentes
...
comment on function public.gerentes_enforce_perm_updates is 'Impide que un no-admin modifique perm_admin/perm_estandar vía API; los admins siguen pudiendo editar a cualquiera.';
