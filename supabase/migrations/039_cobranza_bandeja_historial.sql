...
-- Ejecutar despues de 003_schema_clientes_gastos_cobros.sql y 030_gerentes_rls_asistencia_admin_invite.sql
...
comment on function public.cobranza_ya_enviado_reciente(text, uuid, interval)
is 'Evita duplicados de envio en ventana corta. True si ya existe correo sent reciente para email/cliente.';
